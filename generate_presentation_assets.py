...
colors = ['lightblue', 'lightcoral', 'lightgreen', 'lightcoral', 'lightgreen', 
          'lightyellow', 'lightcoral', 'lightgreen']
...
for i, (layer, y) in enumerate(layers):
    ...
    if i < len(layers) - 1:
        ax.arrow(0.5, y - 0.045, 0, -0.04, head_width=0.05, 
                head_length=0.015, fc='black', ec='black')

ax.set_xlim(0, 1)
ax.set_ylim(0, 1)
ax.set_title('Arhitectura CNN', fontsize=16, fontweight='bold', pad=20)
